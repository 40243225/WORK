 ...
 */
public class HealthPass extends Activity {
    String JSON_STRING;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.health_pass);
        new GetJs().execute();
        No=Main2Activity.No;
    ...
    public void Display(String json_string)
    {
        ...
        try {
            ...
            int count =0;
            String No,TreatmentNo,TreatmentDate,Dis;
            ...
            while(count<jsonArray.length())
            {
                ...
                No=JO.getString("No");
                TreatmentNo=JO.getString("TreatmentNo");
                TreatmentDate=JO.getString("TreatmentDate");
                Dis=JO.getString("DiseaseName");
                text[count]=TreatmentNo;
                Date[count]=TreatmentDate;
                Disease[count]=Dis;
            ...
            ls.setAdapter(new MyAdapter(this,text,Date,Disease));
    ...
    class GetJs extends AsyncTask<Void,Void,String>
    {
        ...
        protected void onPreExecute() {
            ...
            Resources res=HealthPass.this.getResources();
            ip=res.getString(R.string.ip);
            json_url=ip+"app105/Health_Json.php";
        }
